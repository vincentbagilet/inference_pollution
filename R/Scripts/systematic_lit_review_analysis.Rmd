...
Out of all articles returned by the query, `r abstracts_CI %>% filter(contains_CI) %>% distinct(title) %>% nrow()` display confidence intervals. "CI", "confidence interval", etc:
...
articles_retro %>% 
  ...
  geom_point() +
  facet_wrap(~ prop_true_effect) +
  labs(title = "Link between type M and power in the literature", subtitle = "If the magnitude of true effect is a fraction of the measured effect", x = "Power", y = "Type M")
...
articles_retro %>% 
  ...
  geom_point() +
  facet_wrap(~ prop_true_effect) +
  labs(title = "Link between type S and power in the literature", subtitle = "If the magnitude of true effect is a fraction of the measured effect", x = "Power", y = "Type S")
```
