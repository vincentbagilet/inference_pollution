...
abstracts_CI %>% 
  ...
  coord_flip() +
  labs(x = NULL, y = "Number of articles", title = "Main journals in which studies have been published", subtitle = "Comparison between articles for which an effect was detected or not") +
  scale_fill_discrete(name = "")
```
