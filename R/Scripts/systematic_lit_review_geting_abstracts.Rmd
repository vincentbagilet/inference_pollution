...
It might also be interesting to information about the type of pollutant considered in the study, the study period, the number of observations or p-values. We also use regex to recover these information.
