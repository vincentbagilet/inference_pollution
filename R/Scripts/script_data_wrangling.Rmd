...
metadata <- readRDS("~/Documents/Research/imputation_pollution/R/Inputs/metadata_air_pollution_stations.RDS") #I need to fix these links 
raw_pollution_data <- readRDS("~/Documents/Research/imputation_pollution/R/Inputs/raw_air_pollution_data.RDS")
```
