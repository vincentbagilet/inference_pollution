...
graph_missing_by <- function(df, variable_missing, grouping_var, facet_var = NA) {
  graph <- df %>% 
...
data %>%  
  ...
  graph_missing_by(variable_missing = "concentration", grouping_var = "year")
```
...
data %>%  
  ...
  graph_missing_by(variable_missing = "concentration", grouping_var = "year_month") + 
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1))
```
...
data %>%
  ...
  graph_missing_by(variable_missing = "concentration", grouping_var = "month")
...
data %>%  
  ...
  graph_missing_by(variable_missing = "concentration", grouping_var = "month", facet_var = "year")
```
...
data %>%
  ...
  graph_missing_by(variable_missing = "concentration", grouping_var = "day_of_month")
...
data %>%  
  ...
  graph_missing_by(variable_missing = "concentration", grouping_var = "day_of_month", facet_var = "year")
...
data %>%  
  ...
  graph_missing_by(variable_missing = "concentration", grouping_var = "day_of_month", facet_var = "month")
```
...
data %>%
  ...
  graph_missing_by(variable_missing = "concentration", grouping_var = "day_in_week")
...
data %>%  
  ...
  graph_missing_by(variable_missing = "concentration", grouping_var = "day_in_week", facet_var = "year")
...
data %>%  
  ...
  graph_missing_by(variable_missing = "concentration", grouping_var = "day_in_week", facet_var = "month")
```
...
data %>%
  ...
  graph_missing_by(variable_missing = "concentration", grouping_var = "hour")
```
...
data %>%
  mutate(hour = factor(hour(date))) %>% 
  graph_missing_by(variable_missing = "concentration", grouping_var = "hour", facet_var = "country_iso")
```
