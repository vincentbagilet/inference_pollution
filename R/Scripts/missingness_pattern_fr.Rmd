...
graph_distrib_length <- function(df, density, bins_adjust) {
  ...
  if (density) {
    ...
    facet_wrap(~pollutant) +
    labs(title = "Repartition of the length of periods of missing data", subtitle = paste("Comparison across pollutants - One observation per", per, sep = " "), x = "Number of consecutive hours of missing data") 
