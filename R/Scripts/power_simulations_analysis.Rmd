...
summary_simulations <- readRDS("../Outputs/summary_simulations.RDS")
sim_param_base <- read_csv("../Outputs/sim_param_base.csv")
```
...
```{r}
param_by_exp <- crossing(
  var_param =  c("n_days_study", "percent_effect_size", "p_treat"),
