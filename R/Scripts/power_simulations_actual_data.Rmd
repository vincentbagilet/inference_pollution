...
# create_y1(total_data, quasi_exp = "OLS_pm10", formula = "log(deaths_all_causes) ~ pm10 + temperature | city + day_of_week + month^year") %>% select(deaths_all_causes, y1)
```
