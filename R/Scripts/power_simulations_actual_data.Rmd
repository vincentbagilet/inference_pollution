...
# sim_evol <- run_all_sim(nmmaps_data, sim_param_evol, save_every = 10, "sim_evol")
...
We then want to replicate this analysis for a smaller and more realistic number of observations. 
