...
\section{Discussion}\label{section_discussion}
	...
	Instead of mainly interpreting point estimates, we could describe compatibility intervals: the range of effect sizes supported by the data \citep{amrhein_inferential_2019, romer_praise_2020}. Using such measures would better acknowledge the actual uncertainty in the estimates and better serve policy-makers.
