...
```{r loading_packages, code_folding="Code to load the packages used here", results='hide'}
library("groundhog")
packages <- c(
  "here",
  "tidyverse", 
...
```{r data_general_sim, code_folding=FALSE}
...
```{r graph_iv_strength, fig.asp=0.7}
# make the graph
