...
% META-ANALYSIS AND POLICY IMPLICATIONS
...
\end{sloppypar}
        ...
        Based on this subset of articles, we first implement a retrospective power analysis following the same approach as for the analysis of the causal literature. We carry out this analysis for the 1982 estimates that are statistically significant. \Cref{fig:retro_epi} displays the power and exaggeration curves for each result. They describe how these metrics vary with the hypothetical true effect sizes. 
