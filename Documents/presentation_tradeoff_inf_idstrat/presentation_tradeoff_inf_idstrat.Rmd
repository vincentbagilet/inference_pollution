...
- We noticed the existence a key trade-off between identification strategy and power
...
--
  ...
  - if sample size too small or small effect, may still get a statistically significant estimate 
--
