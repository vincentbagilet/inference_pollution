...
- "Fancy" techniques may $\searrow$ omitted variable bias but it may create another type of bias
...
1. Estimate the model:
  - Data and model "formula" $\to$ estimate and p-value
  
---

5\. Loop over $n_{iter}$ iterations:
